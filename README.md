...
1.  **Open the source code and start editing!**
    ...
    Open the `my-shopify-store` directory in your code editor of choice and edit `src/pages/ProductPage.js`. Save your changes and the browser will update in real time!
